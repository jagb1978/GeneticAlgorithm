...
public class PopulationManager {
    ...
    public void stats(Population population, int generation) throws NoIndividualsException{
        ...
        System.out.print("Generation =" + generation + " Avg Fitness =" + (-population.getAveragePopulationFitness())
                + " Best Fitness =" + (-fittestIndividual.getFitness()) + " Avg Size =" + avgNodeLength + "\nBest Individual: ");
