 ...
 */
public class MaxPnlFitnessFunction implements FitnessFunction {
    ...
    private static final int TRADESHORT = 118;
    ...
    public MaxPnlFitnessFunction(double[] preGeneratedRandomConstantValues, int numberOfVariables, int numberOfDataPoints, double[][] targets) {
